...
class WelcomeScreen:
    def __init__(self, root):
        ...
        self.tagline_label = tk.Label(
            self.main_frame,
            text="Advanced Cybersecurity Suite for Comprehensive Protection",
            font=("Arial", 20),
            bg=self.bg_color,
            fg=self.text_color
        )
        ...
        self.description_label = tk.Label(
            ...
            text=(
                ...
                "offering cutting-edge tools to protect your network. "
                "With advanced intrusion detection systems, firewall security, "
                "and real-time traffic monitoring, CyberShield ensures "
